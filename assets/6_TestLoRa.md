...
2. Ensure that you've customized the code with your unique `Network_ID` and `Network_key`, which you should have done already in [Step 4](4_ConfigureSoftware.md).
